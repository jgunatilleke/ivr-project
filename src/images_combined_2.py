...
class image_converter:
    ...
    def detect_joint_angles(self, image, image1):
        ...
        j2_x = np.arctan2(circle1Pos[0] - circle2Pos[0], circle1Pos[2] - circle2Pos[2])
        j2_y = np.arctan2(circle2Pos[1] - circle1Pos[1], circle1Pos[2] - circle2Pos[2])
        j3_x = np.arctan2(circle2Pos[0] - circle3Pos[0], circle2Pos[2] - circle3Pos[2]) - j2_x
        j3_y = np.arctan2(circle2Pos[1] - circle3Pos[1], circle2Pos[2] - circle3Pos[2]) - j2_y

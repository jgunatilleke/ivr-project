...
class image_converter:
  ...
  def callback1(self,data, data1):
    ...
    z_1 = np.pi * np.sin(self.cur_time * np.pi / 15)
    ...
    print("actual joint positions: ", z_1, x_2, y_3, x_4)

    # pass calculated sinusoidal signals to relevant joints
    self.joint1_act = Float64()
    self.joint1_act.data = np.array(z_1)
    ...
    print('estimated from camera1: ', joint_est1)
    print('estimated from camera2: ', joint_est2)
    print('####')
    print('####')
    print()

    self.joints = Float64MultiArray()
    self.joints.data = joint_est1[0], joint_est2[1], joint_est1[2], joint_est2[3]
    ...
    try: 
      ...
      self.robot_joint1_pub.publish(self.joint1_act)
